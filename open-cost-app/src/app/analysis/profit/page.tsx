        ...
        <AppLayout>
            <div className="max-w-4xl mx-auto space-y-6 pb-20">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h1 className="text-2xl font-black italic tracking-tighter text-slate-900 dark:text-white flex items-center gap-2">
                            <Wallet className="h-6 w-6 text-indigo-500" />
                            NET PROFIT REPORT
                        </h1>
                        <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">
                            {analysis.isSimulating ? (
                                <span className="text-indigo-500 animate-pulse">● 시뮬레이션 모드 활성화됨</span>
                            ) : (
                                "실시간 경영 분석 데이터"
                            )}
                        </p>
                ...
                <div className="p-6 bg-slate-950 rounded-2xl border-2 border-slate-900 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10 space-y-2">
                        <div className="flex items-center gap-2 text-[10px] font-black text-indigo-400 uppercase tracking-widest">
                            <Target className="h-3 w-3" /> BUSINESS INSIGHT
                        </div>
                        <p className="text-sm font-bold text-slate-100 leading-relaxed max-w-xl italic">
                ...
                <div className="text-center pt-8">
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest opacity-30 select-none">
