...
export function SourcingOptimizationCard({ opportunities, noWrapper = false }: SourcingOptimizationCardProps) {
            ...
            {topOpportunities.length === 0 ? (
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    {topOpportunities.map(opp => (
                        <div key={opp.ingredientId} className="group relative p-4 bg-white dark:bg-slate-900 rounded-2xl border-none shadow-sm transition-all hover:bg-indigo-50 dark:hover:bg-indigo-900/10">
    ...
    return (
        <Card className="border-none shadow-none bg-indigo-500/[0.03] mb-6">
